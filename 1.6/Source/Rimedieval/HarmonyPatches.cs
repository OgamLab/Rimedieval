...
namespace Rimedieval
{
    ...
    public class PawnWeaponGenerator_TryGenerateWeaponFor
    {
        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            FieldInfo pawnField = AccessTools.Field(AccessTools.Inner(typeof(PawnWeaponGenerator), "<>c__DisplayClass7_0"), "pawn");
    ...
    public class Commonality_Patch
    {
        ...
        {
            if (__instance.thing.IsOdysseyDef() || __instance.thing.IsOdysseyDef())
            {
                return true;
            }
